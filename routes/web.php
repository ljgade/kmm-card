...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('card/my/get_openid', [UserController::class, 'getOpenid'])->name('api.getOpenid');
    ...
    Route::get('h5/edit/del_page', [SceneController::class, 'deletePage'])->name('api.deletePage');
